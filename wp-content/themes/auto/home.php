  ...
  <section class="benefits">
    <div class="container">
      <div class="benefits__inner">
        <img data-wow-delay="2s" class="benefits__images wow animate__fadeInUp animate__animated" src="<?php bloginfo('template_url'); ?> /assets/images/car.png" alt="car">
      ...
      <div class="contacts__inner">
        ...
        <form class="contacts__form">
          <h2 class="title contacts__title">Оставить заявку</h2>
            <?php echo do_shortcode('[contact-form-7 id="a98d9df" title="Контактная форма"]'); ?>
        </form>
      </div>
    </div>
  </section>
